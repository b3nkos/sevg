...
<html>
    <head>
        ...
        <meta charset="UTF-8" />
        <link type="text/plain" rel="author" href="<?php echo site_url('human.txt')?>" />
        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url() ?>">System TVG</a>
                </div>
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="<?php echo site_url('mision')?>">Misión</a></li>
